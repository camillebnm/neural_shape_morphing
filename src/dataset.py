...
from src.model import SIREN, from_pth
...
def _read_ply(path: str, t: float):
    ...
    return faces, torch.from_numpy(vertices).requires_grad_(False)
...
class SpaceTimePointCloudNI(Dataset):
    ...
    def __init__(self, inputpaths, batchsize, device=torch.device("cuda:0"),
                 fraction_on_surface=0.25, fraction_off_surface=0.25, size_domain = 1):
